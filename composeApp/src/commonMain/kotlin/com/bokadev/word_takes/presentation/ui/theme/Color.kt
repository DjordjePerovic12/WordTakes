...
val wordTakesColors = WordTakesColors(
    ...
    wordTakesWhite = Color(0XFFFFFFF0),
    ...
    wordTakesGood = Color(0xFFD7C76B),
    wordTakesAmazing = Color(0xFFA6BE58),
    wordTakesBad = Color(0xFFF1995E),
    wordTakesAwful = Color(0xFFEB704A),
